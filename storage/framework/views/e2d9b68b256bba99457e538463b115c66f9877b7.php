                ...
                <li class="nav-item">
                    <a class="nav-link  <?php echo e(request()->is('administrator*') ? 'active' : ''); ?> " href="/administrator">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa fa-user"
                                style="color: <?php echo e(request()->is('administrator*') ? 'white' : 'black'); ?> !important;"></i>
                        </div>
                    ...
                    <a class="nav-link  <?php echo e(request()->is('post*') ? 'active' : ''); ?> " href="/post">
                        <div
                            ...
                            <i class="fa fa-file-alt"
                                style="color: <?php echo e(request()->is('post*') ? 'white' : 'black'); ?> !important;"></i>
                        </div>
                    ...
                    <a class="nav-link  <?php echo e(request()->is('transaksi*') ? 'active' : ''); ?> " href="/transaksi">
                        <div
                            ...
                            <i class="fas fa-money-bill-alt"
                                style="color:<?php echo e(request()->is('transaksi*') ? 'white' : 'black'); ?> !important;"></i>
                        </div>
                        <span class="nav-link-text ms-1">Transaksi</span>
                    </a>
                </li>
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['isAdmin', 'isPetugas'])): ?>
                <li class="nav-item">
                    <a class="nav-link  <?php echo e(request()->is('penjemputan*') ? 'active' : ''); ?>" href="/penjemputan">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa fa-car-side"
                                style="color: <?php echo e(request()->is('penjemputan*') ? 'white' : 'black'); ?> !important;"></i>
                        </div>
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <a class="nav-link  <?php echo e(request()->is('users*') ? 'active' : ''); ?> " href="/users">
                                <div
                                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa fa-users"
                                        style="color: <?php echo e(request()->is('users*') ? 'white' : 'black'); ?> !important;"></i>
                                </div>
                            ...
                            <a class="nav-link  <?php echo e(request()->is('media*') ? 'active' : ''); ?> " href="/media">
                                <div
                                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa fa-file"
                                        style="color: <?php echo e(request()->is('media*') ? 'white' : 'black'); ?>  !important;"></i>
                                </div>
