<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse  w-auto " style="height:100% !important" id="sidenav-collapse-main">
        <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  {{ request()->is('administrator*') ? 'active' : '' }} " href="/administrator">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa fa-user"
                                style="color: {{ request()->is('administrator*') ? 'white' : 'black' }} !important;"></i>
                        </div>
                    ...
                    <a class="nav-link  {{ request()->is('post*') ? 'active' : '' }} " href="/post">
                        <div
                            ...
                            <i class="fa fa-file-alt"
                                style="color: {{ request()->is('post*') ? 'white' : 'black' }} !important;"></i>
                        </div>
                    ...
                    <a class="nav-link  {{ request()->is('transaksi*') ? 'active' : '' }} " href="/transaksi">
                        <div
                            ...
                            <i class="fas fa-money-bill-alt"
                                style="color:{{ request()->is('transaksi*') ? 'white' : 'black' }} !important;"></i>
                        </div>
                        <span class="nav-link-text ms-1">Transaksi</span>
                    </a>
                </li>
            @endcanany
            @canany(['isAdmin', 'isPetugas'])
                <li class="nav-item">
                    <a class="nav-link  {{ request()->is('penjemputan*') ? 'active' : '' }}" href="/penjemputan">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa fa-car-side"
                                style="color: {{ request()->is('penjemputan*') ? 'white' : 'black' }} !important;"></i>
                        </div>
            ...
            @can('isAdmin')
                <li class="nav-item">
                    <a class="nav-link  {{ request()->is('laporan*') ? 'active' : '' }}" href="/laporan?dari={{ date('Y-m-01') }}&sampai={{ date('Y-m-d') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <a class="nav-link  {{ request()->is('users*') ? 'active' : '' }} " href="/users">
                                <div
                                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa fa-users"
                                        style="color: {{ request()->is('users*') ? 'white' : 'black' }} !important;"></i>
                                </div>
                            ...
                            <a class="nav-link  {{ request()->is('media*') ? 'active' : '' }} " href="/media">
                                <div
                                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa fa-file"
                                        style="color: {{ request()->is('media*') ? 'white' : 'black' }}  !important;"></i>
                                </div>
